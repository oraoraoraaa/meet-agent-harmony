...
| Document | Purpose |
| --- | --- |
| [PRODUCT.md](PRODUCT.md) | Vision, personas, stories, scope |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Modules, contracts, fallbacks |
| [AI_AGENT.md](AI_AGENT.md) | Tools, prompts, grounding |
